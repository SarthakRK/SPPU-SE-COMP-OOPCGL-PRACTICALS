...
/*Develop a program in C++ to create a database of a student's
information system containing the following information: Name, Division,
...
int main()
{
	...
	p2->display();
	int n;
	cout<<"\nEnter How many Records You Want?"<<endl;
	cin>>n;
	person p3[n];
	char name[20];
	int x=0;
